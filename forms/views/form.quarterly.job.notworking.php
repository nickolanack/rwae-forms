...
<span class="inline"> <label><input type="checkbox"
	...
	<label><input type="checkbox"
		...
		name="<?php echo $prefix; ?>-notworking-reason[]" /> Went to self-employment</label> 
	<label><input type="checkbox" value="going-to-school"
		name="<?php echo $prefix; ?>-notworking-reason[]" /> Going to school</label>
	<label><input type="checkbox" value="illness-or-disability"
		name="<?php echo $prefix; ?>-notworking-reason[]" /> Not at their job this quarter because of Illness/disability</label> 
	<label><input
		type="checkbox" value="waiting-for-recall"
		name="<?php echo $prefix; ?>-notworking-reason[]" /> Waiting for recall</label>
	<label><input type="checkbox" value="laid-off-indefinitely"
		name="<?php echo $prefix; ?>-notworking-reason[]" /> Laid off indefinitely</label>
	<label><input type="checkbox" value="laid-off-indefinitely"
		name="<?php echo $prefix; ?>-notworking-reason[]" /> Seasonal contract Ended</label>
	<label><input type="checkbox" value="seasonal-ended"
		name="<?php echo $prefix; ?>-notworking-reason[]" /> Quit</label> 
	<label><input
